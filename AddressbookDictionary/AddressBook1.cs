...
namespace AddressBookDict
{
    class AddressBook1
    {
        ...
        public AddressBook1(int id1, string fname, string lname, int phone, string mail, string address,
        ...
        public static AddressBook1 accept()
        {
            ...
            AddressBook1 uc1 = new AddressBook1(id1, fname, lname, phone, mail, address, city, state, zip);
            id += 1;
            return uc1;
        ...
        public static void display(List<AddressBook1> list)
        {
        ...
        internal static int Update(List<AddressBook1> list, string fn, string ln)
        {
        ...
        internal static int Delete(List<AddressBook1> list, string fn, string ln)
        {
